...
import (
	...
	"go_code/RPC/kitex_gen/example/shop/base"
	"strings"
)
...
type GetItemReq struct {
	LongURL string `thrift:"longURL,1,required" frugal:"1,required,string" json:"longURL"`
}
...
func (p *GetItemReq) GetLongURL() (v string) {
	return p.LongURL
}
func (p *GetItemReq) SetLongURL(val string) {
	p.LongURL = val
}
...
func (p *GetItemReq) Field1DeepEqual(src string) bool {
...
type GetItemResp struct {
	...
	ShortURL string         `thrift:"shortURL,2,required" frugal:"2,required,string" json:"shortURL"`
...
func (p *GetItemResp) GetShortURL() (v string) {
	return p.ShortURL
}
...
func (p *GetItemResp) SetShortURL(val string) {
	p.ShortURL = val
}
...
func (p *GetItemResp) Field2DeepEqual(src string) bool {
